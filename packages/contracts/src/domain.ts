...
export const ASSISTANT_STREAM_PHASE = {
  ANALYZING: "analyzing",
  TOOL: "tool",
  DRAFTING: "drafting",
  FINALIZING: "finalizing",
} as const;
export const ASSISTANT_STREAM_PHASE_VALUES = [
  ASSISTANT_STREAM_PHASE.ANALYZING,
  ASSISTANT_STREAM_PHASE.TOOL,
  ASSISTANT_STREAM_PHASE.DRAFTING,
  ASSISTANT_STREAM_PHASE.FINALIZING,
] as const;
export type AssistantStreamPhase = ValueOf<typeof ASSISTANT_STREAM_PHASE>;
