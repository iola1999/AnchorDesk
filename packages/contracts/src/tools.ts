...
export const ASSISTANT_TOOL = {
  ...
  READ_CONVERSATION_ATTACHMENT_RANGE: "read_conversation_attachment_range",
...
export const ASSISTANT_MCP_TOOL = {
  ...
  READ_CONVERSATION_ATTACHMENT_RANGE: `${ASSISTANT_MCP_TOOL_PREFIX}${ASSISTANT_TOOL.READ_CONVERSATION_ATTACHMENT_RANGE}`,
  ...
  FETCH_SOURCES: `${ASSISTANT_MCP_TOOL_PREFIX}${ASSISTANT_TOOL.FETCH_SOURCES}`,
...
export const ASSISTANT_ALLOWED_TOOL_NAMES = [
  ...
  ASSISTANT_MCP_TOOL.READ_CONVERSATION_ATTACHMENT_RANGE,
