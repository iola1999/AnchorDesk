    ...
    <>
      <button
        ...
        className={cn(
          ...
          "gap-2 border-app-border/80 bg-white/82 pl-1.5 pr-3 shadow-soft backdrop-blur-sm hover:border-app-border-strong hover:bg-white",
        )}
      ...
      >
        ...
        <span className="text-[13px] font-medium text-app-text">{triggerLabel}</span>
      </button>
